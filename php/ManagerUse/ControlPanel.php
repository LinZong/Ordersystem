...
<title>Control Panel For Manager</title>
</head>
<style>
body{
...
echo "<a href='SearchLibrary.php'><input type='button' id='button1' name='UploadLibrary' value='更新库存'></a>";
echo "<a href='AddObjectToLibrary.php'><input type='button' id='button1' name='UploadKind' value='更新品种'>";
...
echo "<a href='../SellerUse/Main.php'><input type='button' id='button1' name='Entertotheseller' value='进入售货员界面操作'></a>";
